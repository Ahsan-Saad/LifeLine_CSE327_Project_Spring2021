...
class DiabeteseSp_List extends StatefulWidget {
  @override
  _DiabeteseSp_ListState createState() => _DiabeteseSp_ListState();
}

class _DiabeteseSp_ListState extends State<DiabeteseSp_List> {
  @override
            ...
            Column(
              children: [
                Container(
                  ...
                  child: Text(
                    "List of Diabetese specialists in Dhaka:",
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 22,
