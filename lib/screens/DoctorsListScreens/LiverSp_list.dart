...
class LiverSp_list extends StatefulWidget {
  @override
  _LiverSp_listState createState() => _LiverSp_listState();
}

class _LiverSp_listState extends State<LiverSp_list> {
  @override
            ...
            Column(
              children: [
                Container(
                  ...
                  child: Text(
                    "List of Liver specialists in Dhaka:",
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 22,
